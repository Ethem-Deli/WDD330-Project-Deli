import"./modulepreload-polyfill-B5Qt9EMX.js";import{l as m,g as h,e as p,c as u,s as f}from"./favorites-JPAmtfbB.js";import{r as g}from"./auth-CRiUk8YE.js";import"https://www.gstatic.com/firebasejs/10.14.0/firebase-app.js";import"https://www.gstatic.com/firebasejs/10.14.0/firebase-auth.js";import"https://www.gstatic.com/firebasejs/10.14.0/firebase-firestore.js";g("auth/login.html");async function c(e,a){const t=document.querySelector(a);if(t)try{const o=await fetch(e);if(!o.ok)throw new Error("Not found");const r=await o.text();t.innerHTML=r,t.querySelectorAll("script").forEach(i=>{const n=document.createElement("script");i.src?n.src=i.src:n.text=i.innerText,document.body.appendChild(n)})}catch{e.endsWith("header.html")?t.innerHTML=`
